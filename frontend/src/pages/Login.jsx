      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-8">
            <a href="#home" className="text-gray-600 hover:text-[#8B4A5A] transition-colors text-sm font-medium uppercase tracking-wide">
              Home
            </a>
            <a href="#products" className="text-gray-600 hover:text-[#8B4A5A] transition-colors text-sm font-medium uppercase tracking-wide">
              Products
            </a>
            <a href="#about" className="text-gray-600 hover:text-[#8B4A5A] transition-colors text-sm font-medium uppercase tracking-wide">
              About
            </a>
            <a href="#contact" className="text-gray-600 hover:text-[#8B4A5A] transition-colors text-sm font-medium uppercase tracking-wide">
              Contact
            </a>
          </div>
        ...
        {/* Copyright */}
        <div className="border-t border-[#D4A3A3]/30 mt-8 pt-8 text-center">
