    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
                ...
                <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-4 border border-white/60">
                  ...
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="inline-block bg-white/95 backdrop-blur-sm text-[#8B4A5A] text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-full shadow-lg">
                        {product.category}
                      </span>
                    </div>
                    
                    <div className="absolute top-4 right-4">
                      <span className="inline-block bg-[#8B4A5A] text-white text-lg font-bold px-4 py-2 rounded-full shadow-lg">
                        {product.price}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-8">
                    <h3 className="text-2xl font-serif font-bold text-gray-900 mb-3 group-hover:text-[#8B4A5A] transition-colors">
                      {product.name}
                    </h3>
                    ...
                    <button className="w-full bg-gradient-to-r from-[#8B4A5A] to-[#723C4B] hover:from-[#723C4B] hover:to-[#4A2028] text-white py-4 rounded-full font-semibold text-sm transition-all hover:shadow-xl hover:scale-[1.02] uppercase tracking-wider">
                      Add to Order →
                    </button>
                  </div>

                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#D4A3A3]/40 to-transparent rounded-tr-3xl rounded-bl-full pointer-events-none"></div>
                </div>
              </div>
            );
          })}
        ...
        <div className="text-center mt-20 animate-fade-in-up">
          ...
          <a 
            href="#contact"
            className="inline-block bg-white border-2 border-[#8B4A5A] text-[#8B4A5A] hover:bg-[#8B4A5A] hover:text-white px-10 py-4 rounded-full font-semibold transition-all hover:scale-105 hover:shadow-xl uppercase tracking-wide text-sm"
          >
