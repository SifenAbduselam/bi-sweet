    ...
    products: [
      {
        ...
        sizes: {
          small: { label: "Small", price: "600 Br" },
          large: { label: "Large", price: "700 Br" },
        },
      },
      {
        id: 2,
      ...
      },
      {
        ...
        name: "Kinder",
        description:
          "Rich chocolate and hazelnut cream layered with crispy wafer, topped with premium Kinder chocolate", // 👈 FIXED DESCRIPTION
        sizes: {
          small: { label: "Small", price: "600 Br" },
          large: { label: "Large", price: "700 Br" },
        },
